...
## Purpose
Define the canonical requirements for breadcrumb navigation that displays the current location and path within the application, particularly for forms and multi-step wizards.
