...
## Purpose
Define the canonical requirements for the main application navigation bar, which provides access to key sections (Products, Categories) and maintains visual state to indicate the current section.
